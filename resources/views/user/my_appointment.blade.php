...
<head>
  ...
  <title>Afya Bora - Medical Center HTML5 Template</title>
...
<body>
  ...
  <header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +254-727-025-745</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span>eddiebarasa.20@gmail.com</a>
            </div>
          </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="{{url('/')}}"><span class="text-primary">Afya</span>-Bora</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            @if(Route::has('login'))
              @auth
                ...
                <li class="nav-item">
                  <a class="nav-link" style="background-color: red; color: white;" href="{{url('myappointment')}}">My Appointment</a>
                </li>
...
<div align="center" style="padding:70px;" class="">
